 ...
 *   The strncpy_s function copies not more than n successive characters (not including the terminating null
 ...
 *    EINVAL_AND_RESET       strDest !=  NULL and strSrc is NULL and destMax != 0 and destMax <=
 * SECUREC_STRING_MAX_LEN ERANGE                         destMax is 0 and destMax > SECUREC_STRING_MAX_LEN
