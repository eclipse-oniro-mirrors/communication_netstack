 ...
 *
 * OpenArkCompiler is licensed under the Mulan PSL v2.
...
#define SECUREC_MEMSET_PARAM_OK(dest, destMax, count) \
    (SECUREC_LIKELY((destMax) <= SECUREC_MEM_MAX_LEN && (dest) != NULL && (count) <= (destMax)))
        ...
        switch (c) {                                                                                               \
            case 0:                                                                                                \
                switch (count) {                                                                                   \
                    ...
                    case 10:                                                                                       \
                        *(SecStrBuf10 *)(dest) =                                                                   \
                            *(const SecStrBuf10 *)(&((SecStrictAliasingCast(&g_allZero))->buf10));                 \
                        break;                                                                                     \
                    case 11:                                                                                       \
                        *(SecStrBuf11 *)(dest) =                                                                   \
                            *(const SecStrBuf11 *)(&((SecStrictAliasingCast(&g_allZero))->buf11));                 \
                        break;                                                                                     \
                    case 12:                                                                                       \
                        *(SecStrBuf12 *)(dest) =                                                                   \
                            *(const SecStrBuf12 *)(&((SecStrictAliasingCast(&g_allZero))->buf12));                 \
                        break;                                                                                     \
                    case 13:                                                                                       \
                        *(SecStrBuf13 *)(dest) =                                                                   \
                            *(const SecStrBuf13 *)(&((SecStrictAliasingCast(&g_allZero))->buf13));                 \
                        break;                                                                                     \
                    case 14:                                                                                       \
                        *(SecStrBuf14 *)(dest) =                                                                   \
                            *(const SecStrBuf14 *)(&((SecStrictAliasingCast(&g_allZero))->buf14));                 \
                        break;                                                                                     \
                    case 15:                                                                                       \
                        *(SecStrBuf15 *)(dest) =                                                                   \
                            *(const SecStrBuf15 *)(&((SecStrictAliasingCast(&g_allZero))->buf15));                 \
                        break;                                                                                     \
                    case 16:                                                                                       \
                        *(SecStrBuf16 *)(dest) =                                                                   \
                            *(const SecStrBuf16 *)(&((SecStrictAliasingCast(&g_allZero))->buf16));                 \
                        break;                                                                                     \
                    case 17:                                                                                       \
                        *(SecStrBuf17 *)(dest) =                                                                   \
                            *(const SecStrBuf17 *)(&((SecStrictAliasingCast(&g_allZero))->buf17));                 \
                        break;                                                                                     \
                    case 18:                                                                                       \
                        *(SecStrBuf18 *)(dest) =                                                                   \
                            *(const SecStrBuf18 *)(&((SecStrictAliasingCast(&g_allZero))->buf18));                 \
                        break;                                                                                     \
                    case 19:                                                                                       \
                        *(SecStrBuf19 *)(dest) =                                                                   \
                            *(const SecStrBuf19 *)(&((SecStrictAliasingCast(&g_allZero))->buf19));                 \
                        break;                                                                                     \
                    case 20:                                                                                       \
                        *(SecStrBuf20 *)(dest) =                                                                   \
                            *(const SecStrBuf20 *)(&((SecStrictAliasingCast(&g_allZero))->buf20));                 \
                        break;                                                                                     \
                    case 21:                                                                                       \
                        *(SecStrBuf21 *)(dest) =                                                                   \
                            *(const SecStrBuf21 *)(&((SecStrictAliasingCast(&g_allZero))->buf21));                 \
                        break;                                                                                     \
                    case 22:                                                                                       \
                        *(SecStrBuf22 *)(dest) =                                                                   \
                            *(const SecStrBuf22 *)(&((SecStrictAliasingCast(&g_allZero))->buf22));                 \
                        break;                                                                                     \
                    case 23:                                                                                       \
                        *(SecStrBuf23 *)(dest) =                                                                   \
                            *(const SecStrBuf23 *)(&((SecStrictAliasingCast(&g_allZero))->buf23));                 \
                        break;                                                                                     \
                    case 24:                                                                                       \
                        *(SecStrBuf24 *)(dest) =                                                                   \
                            *(const SecStrBuf24 *)(&((SecStrictAliasingCast(&g_allZero))->buf24));                 \
                        break;                                                                                     \
                    case 25:                                                                                       \
                        *(SecStrBuf25 *)(dest) =                                                                   \
                            *(const SecStrBuf25 *)(&((SecStrictAliasingCast(&g_allZero))->buf25));                 \
                        break;                                                                                     \
                    case 26:                                                                                       \
                        *(SecStrBuf26 *)(dest) =                                                                   \
                            *(const SecStrBuf26 *)(&((SecStrictAliasingCast(&g_allZero))->buf26));                 \
                        break;                                                                                     \
                    case 27:                                                                                       \
                        *(SecStrBuf27 *)(dest) =                                                                   \
                            *(const SecStrBuf27 *)(&((SecStrictAliasingCast(&g_allZero))->buf27));                 \
                        break;                                                                                     \
                    case 28:                                                                                       \
                        *(SecStrBuf28 *)(dest) =                                                                   \
                            *(const SecStrBuf28 *)(&((SecStrictAliasingCast(&g_allZero))->buf28));                 \
                        break;                                                                                     \
                    case 29:                                                                                       \
                        *(SecStrBuf29 *)(dest) =                                                                   \
                            *(const SecStrBuf29 *)(&((SecStrictAliasingCast(&g_allZero))->buf29));                 \
                        break;                                                                                     \
                    case 30:                                                                                       \
                        *(SecStrBuf30 *)(dest) =                                                                   \
                            *(const SecStrBuf30 *)(&((SecStrictAliasingCast(&g_allZero))->buf30));                 \
                        break;                                                                                     \
                    case 31:                                                                                       \
                        *(SecStrBuf31 *)(dest) =                                                                   \
                            *(const SecStrBuf31 *)(&((SecStrictAliasingCast(&g_allZero))->buf31));                 \
                        break;                                                                                     \
                    case 32:                                                                                       \
                        *(SecStrBuf32 *)(dest) =                                                                   \
                            *(const SecStrBuf32 *)(&((SecStrictAliasingCast(&g_allZero))->buf32));                 \
                        break;                                                                                     \
                    default:                                                                                       \
                        break;                                                                                     \
                }                                                                                                  \
