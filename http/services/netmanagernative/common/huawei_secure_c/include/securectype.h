...
/*
 * This is a built-in function that can be used without a declaration, if you encounter an undeclared compilation
 * alarm, you can add -DSECUREC_NEED_BUILTIN_EXPECT_DECLARE to complier options
 */
