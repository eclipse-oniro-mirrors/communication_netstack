...
public:
    netlink_msg(uint16_t flags, size_t maxBufLen, int pid);
    ...
    void addTrafficControl(unsigned short action, struct tcmsg msg);
    void addInetDiag(unsigned short action, struct inet_diag_req_v2 msg);
